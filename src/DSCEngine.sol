...
import {OracleLib} from "../src/librabries/OracleLib.sol";
/**
 * @title DSCEngine
 * @author Daniel Vo
 *
 * The system is designed to be as minimal as posible and have tokens maintain a 1 token == $1 peg.
...
contract DSCEngine is ReentrancyGuard {
    ...
    /**
     *
     * @param toknCollateralAddress The address of the token to deposit as collateral
     * @param amountCollateral The amount of collateral to deposit
     * @param amountDscToMint The amount of decentralized stablecoin to mint
     * @notice this function will deposit your collateral and mint DSC in one transaction
     */
    function depositCollateralAndMintDsc(
        address toknCollateralAddress,
        uint256 amountCollateral,
        uint256 amountDscToMint
    ) external {
        depositCollateral(toknCollateralAddress, amountCollateral);
     ...
     * @notice follows CEI
     * @param amountDscToMint The amount of decentralized stablecoin to mint
     * @notice they must more collateral value than the minimum thresold
     */
    ...
    /**
     * @dev Low-level internal function, do not call unless the function calling it is checking for health being broken
     */
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        uint256 collateralAdjustedForThreshold = (collateralValueInUsd * LIQUIDATION_THRESHOLD) / LIQUIDATION_PRECISION; // (x*50)/100
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        (, int256 price,,,) = priceFeed.staleCheckLatestRoundData();
        //  1 ETH = $1000
        // The returned value from CL will be 1000 * 1e8 check chainlink
